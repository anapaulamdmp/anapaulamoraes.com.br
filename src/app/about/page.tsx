            ...
            <header className='sticky top-0 bg-slate-50 px-4 flex flex-col pt-32 pb-2 border-b border-slate-200'>
              <div className='flex flex-row'>
                  <div className='flex flex-col max-w-sm gap-1'>
                      they/them
                      <h1 className='text-3xl font-bold text-gray-700'>Ana Paula Moraes</h1>
                      Experience designer currently working on projects that explore Augmented Reality, Virtual Reality and Metaverse for Banco do Brasil.
                  </div>
                    ...
                    <div className='flex flex-row gap-10'>
                      ...
                      <div className='flex flex-col flex-1'>
                          <div className='flex flex-col'>
                            ...
                            <a href='' className='font-bold text-2xl mt-5 text-slate-700'>Banco do Brasil's Value Chain: reshaping data visualization for easier readings and enchanting audience</a>
